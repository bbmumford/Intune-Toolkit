...
############################################################################################
##
## Script to install the latest Bitdefender
## 
## VER 4.0.5
##
## Change Log
...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    weburl="https://cloud.gravityzone.bitdefender.com/Packages/MAC/0/#######/setup_downloader.dmg" 
    else
    # This is x64 URL
    weburl="https://cloud.gravityzone.bitdefender.com/Packages/MAC/0/#######/setup_downloader.dmg"   
fi

appname="Bitdefender"                                                      # The name of our App deployment script (also used for Octory monitor)
app="Bitdefender.app"                                                      # The actual name of our App once installed
...
processpath="$appdir/$app/Contents/MacOS/ABitdefender"                      # The process name of the App we are installing
