...
############################################################################################
##
## Script to install the latest Asana App
## 
## VER 4.0.5
##
## Change Log
...
if [[ $(uname -m) == 'arm64' ]]; then
    ...
    weburl="https://desktop-downloads.asana.com/darwin_universal/prod/latest/Asana.dmg" 
    else
    # This is x64 URL
    weburl="https://desktop-downloads.asana.com/darwin_universal/prod/latest/Asana.dmg"   
fi

appname="Asana"                                                      # The name of our App deployment script (also used for Octory monitor)
app="Asana.app"                                                      # The actual name of our App once installed
...
processpath="$appdir/$app/Contents/MacOS/Asana"                      # The process name of the App we are installing
